...
<div class="container">
    <form action="" method="post" name="Login_Form" class="form-signin">
        ...
        <?php
        $UsernameAdmin = "AppleGeekSquad";
        $PasswordAdmin = "Matthew04302003";
        $UsernameDefault = "user";
        $PasswordDefault = "user";
        /* Check if login form has been submitted */
        if(isset($_POST['Submit'])){
            /* Check if form's username and password matches */
            if( ($_POST['Username'] == $UsernameDefault) && ($_POST['Password'] == $PasswordDefault) ) {
                /* Success: Set session variables and redirect to protected page */
                $_SESSION['Username'] = $Username;
                $_SESSION['Active'] = true;
                header("location:index.php");
                exit;
            } elseif( ($_POST['Username'] == $UsernameAdmin) && ($_POST['Password'] == $PasswordAdmin) ) {
                $_SESSION['Username'] = $Username;
                $_SESSION['Active'] = true;
                header("location:index.php");
                exit;
