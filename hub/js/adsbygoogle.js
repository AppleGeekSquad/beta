(function() {
    ...
    var l = this,
        ...
        qa = function() {
            if (null === oa) {
                a: {
                    var a = l.document;
                    if ((a = a.querySelector && a.querySelector("script[nonce]")) && (a = a.nonce || a.getAttribute("nonce")) && pa.test(a)) break a;a = null
                }
                oa = a || ""
            }
            return oa
    ...
    var Ea = function(a) {
        ...
        Ma = function(a) {
            if (!Fa.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(Ga, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(Ha, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(Ia, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(Ja, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(Ka, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(La, "&#0;"));
            return a
        },
        Ga = /&/g,
        Ha = /</g,
        ...
        Xa = function(a, b, c) {
            ...
            a: {
                if (b = a.b.length) {
                    --b;
                    var d = a.b[b];
                    if (d && "object" == typeof d && "array" != sa(d) && !(Ua && d instanceof Uint8Array)) {
                        a.i = b - a.h;
                        a.f = d;
                        break a
                    }
        ...
        try {
            ...
            if (h.location && h.location.ancestorOrigins && h.location.ancestorOrigins.length == b.length - 1)
                for (m = 1; m < b.length; ++m) {
                    var n = b[m];
                    n.url || (n.url = h.location.ancestorOrigins[m - 1] || "", n.aa = !0)
                }
    ...
    var fe = function(a) {
        this.a = this.b = null;
        "function" == sa(a) ? this.a = a : this.b = a
    };
    ...
    var J = function(a, b, c, d) {
        ...
        Fe = function(a, b) {
            ...
            if (c) return c;
            c = Infinity;
            do(d = b.style && C(b.style.height)) && (c = Math.min(c, d)), (d = J(b, a, "maxHeight", C)) && (c = Math.min(c, d)); while ((b = b.parentElement) && "HTML" != b.tagName);
            return c
        },
        Be = function(a, b) {
    ...
    var Oe = function(a, b, c) {
        ...
        Qe = function(a, b) {
            ...
            if (null !== d && Za(d, 2)) return a = a.a.google_ama_state = a.a.google_ama_state || {}, a.eatf = !0, yd(7, [!0, 0, !1]), !0;
            d = 0;
            var e = ab(a.h, vc, 1);
            for (c = 0; c < e.length; c++) {
                ...
                if (1 == y(f, 8)) {
                    var g = $a(f, tc, 4);
                    if (g && 2 == y(g, 1) && (d++, Pe(a, f, b))) return a.b = !0, a = a.a.google_ama_state = a.a.google_ama_state || {}, a.placement = c, yd(7, [!1, d, !0]), !0
                }
            }
            yd(7, [!1, d, !1]);
            return !1
        ...
        Pe = function(a, b, c) {
            ...
            if (k.length) {
                ...
                k = le(e, k);
                p(e.b) && (h = e.b, 0 > h && (h += k.length), k = 0 <= h && h < k.length ? [k[h]] : []);
                if (p(e.f)) {
                    h = [];
                    for (d = 0; d < k.length; d++) f = ne(k[d]), g = e.f, 0 > g && (g += f.length), 0 <= g && g < f.length && h.push(f[g]);
                    k = h
                }
                e = k
            } else e = [];
            ...
            b = $a(b, sc, 3);
            h = {};
            b && (h.ea = y(b, 1), h.X = y(b, 2), h.oa = !!y(b, 3));
            b = a.a;
            c = a.f;
            d = a.i;
            f = b.document;
            ...
            a: {
                try {
                    ...
                    a && a.parentNode && (q = a.parentNode, q.removeChild(a), Ge(q) && (q.style.display = q.getAttribute("data-init-display") || "none"));
                    q = !1;
                    break a
                }
                q = !0
        ...
        try {
            ...
            if (v(c.toLowerCase(), "stylesheet")) var g = mb(b);
                ...
                if (b instanceof lb) var h = mb(b);
                    ...
                    if (b instanceof ob)
                        if (b instanceof ob && b.constructor === ob && b.la === nb) var k = b.M;
                        else sa(b), k = "type_error:SafeUrl";
                    else {
    ...
    var M = function(a, b) {
        ...
        rf = function(a, b, c, d, e, f) {
            ...
            f = void 0 === f ? 1 : f;
            0 >= d ? c = null : (g = new Oc(c, c + d - 1), (d = d % f || d / f % e.length) || (b = b.a, d = !(b.start <= g.start && b.a >= g.a)), d ? c = null : (a = Qc(a), c = null !== a && g.start <= a && g.a >= a ? e[Math.floor((a - c) / f) % e.length] : null));
            return c
        };
    var sf = function(a) {
        if (!a) return "";
    ...
    var tf = function(a, b, c, d) {
        ...
        uf = function(a, b, c) {
            if (A(a.document.getElementById(b).contentWindow)) a = a.document.getElementById(b).contentWindow, b = a.document, b.body && b.body.firstChild || (/Firefox/.test(navigator.userAgent) ? b.open("text/html", "replace") : b.open(), a.google_async_iframe_close = !0, b.write(c));
            else {
    ...
    var P = function(a, b, c, d, e, f, g, h, k, m, n) {
            ...
            this.I = this.u = this.s = null
        },
        xf = function(a, b, c) {
            null != a.C && (c.google_responsive_formats = a.C);
            null != a.H && (c.google_safe_for_responsive_override = a.H);
            ...
            var d = a.a.a(b),
                e = a.a.height();
            1 != c.google_ad_resize && (c.google_ad_width = d, c.google_ad_height = e, c.google_ad_format = a.a.f(b), c.google_responsive_auto_format = a.O, c.google_ad_resizable = !0, c.google_override_format = 1, c.google_loader_features_used = 128, !0 === a.b && (c.gfwrnh = a.a.height() + "px"));
            null != a.B && (c.gfwroml = a.B);
            null != a.F && (c.gfwromr = a.F);
            ...
            b = gc();
            b = jc(b) || b;
            if (bf(b.location, "google_responsive_slot_debug") || qf(b, Ud.c, Ud.g)) c.ds = "outline:thick dashed " + (d && e ? !0 !== a.b || !0 !== a.f ? "#ffa500" : "#0f0" : "#f00") + " !important;"
        };
    var yf = ["google_content_recommendation_ui_type", "google_content_recommendation_columns_num", "google_content_recommendation_rows_num"],
        Q = {},
    ...
    var Ef = function(a) {
            ...
            throw new G("Tags data-matched-content-ui-type, data-matched-content-columns-num and data-matched-content-rows-num should be set together.");
        },
        If = function(a, b) {
            Ff(a, b);
            if (a < Rb) {
    ...
    function Hf(a) {
        return 1200 <= a ? new Df(1200, 600) : 850 <= a ? new Df(a, Math.floor(.5 * a)) : 550 <= a ? new Df(a, Math.floor(.6 * a)) : 468 <= a ? new Df(a, Math.floor(.7 * a)) : new Df(a, Math.floor(3.44 * a))
    }
    var Jf = function(a, b) {
        Ff(a, b);
        ...
        a: {
            if (c.length == d.length && d.length == e.length) {
                ...
                throw new G("The parameter length of attribute data-matched-content-ui-type, data-matched-content-columns-num and data-matched-content-rows-num is too long. At most 2 parameters for each attribute are needed: one for mobile and one for desktop, while " + ("you are providing " + c.length + ' parameters. Example: \n data-matched-content-rows-num="4,2"\ndata-matched-content-columns-num="1,6"\ndata-matched-content-ui-type="image_stacked,image_card_sidebyside".'));
            }
            if (c.length != d.length) throw new G('The parameter length of data-matched-content-ui-type does not match data-matched-content-columns-num. Example: \n data-matched-content-rows-num="4,2"\ndata-matched-content-columns-num="1,6"\ndata-matched-content-ui-type="image_stacked,image_card_sidebyside".');
            throw new G('The parameter length of data-matched-content-columns-num does not match data-matched-content-rows-num. Example: \n data-matched-content-rows-num="4,2"\ndata-matched-content-columns-num="1,6"\ndata-matched-content-ui-type="image_stacked,image_card_sidebyside".');
        }
        c = c[f];
    ...
    function Ff(a, b) {
        if (0 >= a) throw new G("Invalid responsive width from Matched Content slot " + b.google_ad_slot + ": " + a + ". Please ensure to put this Matched Content slot into a non-zero width div container.");
    }
    ...
    var S = [new O(970, 90, 2), new O(728, 90, 2), new O(468, 60, 2), new O(336, 280, 1), new O(320, 100, 2), new O(320, 50, 2), new O(300, 600, 4), new O(300, 250, 1), new O(250, 250, 1), new O(234, 60, 2), new O(200, 200, 1), new O(180, 150, 1), new O(160, 600, 4), new O(125, 125, 1), new O(120, 600, 4), new O(120, 240, 4), new O(120, 120, 1, !0)],
        Nf = [S[6], S[12], S[3], S[0], S[7], S[14], S[1], S[8], S[10], S[4], S[15], S[2], S[11], S[5], S[13], S[9], S[16]];
    var Pf = function(a, b, c, d, e) {
            "false" != e.google_full_width_responsive || c.location && "#gfwrffwaifhp" == c.location.hash ? "auto" == b || 0 < (ue(b) & 1) || "autorelaxed" == b && cc(kc(c), Yd.g) || Of(b) || 1 == e.google_ad_resize ? (b = we(a, c, d, e), c = !0 !== b ? {
                j: a,
                l: b
            } : {
                j: H(c) || a,
        ...
        Sf = function(a, b, c, d, e) {
            ...
            r = J(d, c, "zIndex") || "";
            return new P(q, g, u, n, f, h, K, V, m, k, r)
        },
        Of = function(a) {
        ...
        Qf = function(a, b, c, d, e, f) {
            ...
            var q = Mf(m, Lf(n), Lf(u));
            if (!q) throw new G("No slot size for availableWidth=" + a);
    ...
    var $f = function(a, b, c, d, e) {
        var f;
        (f = H(b)) ? 488 > H(b) ? b.innerHeight >= b.innerWidth ? (e.google_full_width_responsive_allowed = !0, ye(b, c, c.parentElement, a, f, e), f = {
            j: f,
            l: !0
        }) : f = {
            j: a,
        ...
        a = Qf(f, "auto", b, c, e, !0);
        return new P(12, a.w, a.N, !0, g, a.v)
    };
    var ag = function(a) {
        ...
        cg = function(a, b, c, d, e) {
            e = b.offsetWidth || (c.google_ad_resize || (void 0 === e ? !1 : e)) && J(b, d, "width", C) || c.google_ad_width || 0;
        ...
        bg = function(a, b, c, d, e) {
            ...
            switch (a) {
                case 5:
                    ...
                    }), f = a.j, a = a.l, !0 === a && b != f && ye(e, c, c.parentElement, b, f, d), !0 === a ? d.google_full_width_responsive_allowed = !0 : (d.google_full_width_responsive_allowed = !1, d.gfwrnwer = a), If(f, d);
                case 9:
                    return Jf(b, d);
                case 4:
                    return a = Zf(b, e, c, d), Yf(a, Fe(e, c), f, D(e, Ed.R) ? 250 : 190);
                case 8:
                    return Wf(b, e, c, f, d);
                case 10:
                    return $f(b, e, c, f, d)
    ...
    var gg = function(a) {
        ...
        hg = function(a) {
            return !!a && ("object" === typeof a || "function" === typeof a) && gg(a) && bc(a.nq) && bc(a.nqa) && bc(a.al) && bc(a.rl)
        },
        ig = function() {
    ...
    U.prototype.nq = U.prototype.F;
    U.prototype.nqa = U.prototype.i;
    U.prototype.al = U.prototype.H;
    U.prototype.rl = U.prototype.s;
    U.prototype.sz = U.prototype.I;
    U.prototype.tc = U.prototype.G;
    var eg = function(a, b) {
        this.b = a;
        this.a = b
    };
    ...
    var mg = function(a, b) {
        ...
        og = Ma("var i=this.id,s=window.google_iframe_oncopy,H=s&&s.handlers,h=H&&H[i],w=this.contentWindow,d;try{d=w.document}catch(e){}if(h&&d&&(!d.body||!d.body.firstChild)){if(h.call){setTimeout(h,0)}else if(h.match){try{h=s.upd(h,i)}catch(e){}w.location.replace(h)}}");
    var pg = {},
        qg = (pg.google_ad_modifications = !0, pg.google_analytics_domain_name = !0, pg.google_analytics_uacct = !0, pg.google_pause_ad_requests = !0, pg);
    var tg = function() {
            var a = l;
    ...
    var zg = /^\.google\.(com?\.)?[a-z]{2,3}$/,
                ...
                if (!Y.L()) {
                    var a = l.document,
                        b = function(b) {
                            ...
                            rb(c, b);
                            try {
                                (a.head || a.body || a.documentElement).appendChild(c), Y.va()
                            } catch (h) {}
                        },
                        c = X[1];
                    b(c);
        ...
        Fg = function(a) {
            ...
            a && (0 != b || W[3] >= +new Date ? Y.Y(a) : (Y.$().push(a), Y.ca()));
            W[3] >= +new Date && W[2] >= +new Date || Y.ca()
        },
        Gg = function(a) {
            l.processGoogleToken = l.processGoogleToken || function(a, c) {
                ...
                var k = Cg.googleToken = Cg.googleToken || {},
                    m = 0 == c && a && ma(a) && !e && p(f) && 0 < f && p(g) && 0 < g && ma(h);
                e = e && !Y.L() && (!(W[3] >= +new Date) || "NT" == W[1]);
                var n = !(W[3] >= +new Date) && 0 != c;
                if (m || e || n) e = +new Date, f = e + 1E3 * f, g = e + 1E3 * g, 1E-5 > Math.random() && Nb("https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err=" + c, void 0), k[5] = c, k[1] = a, k[2] = f, k[3] = g, k[4] = h, k[6] = b, Eg();
                if (m || !Y.L()) {
                    c = Y.$();
                    for (a = 0; a < c.length; a++) Y.Y(c[a]);
                    c.length = 0
                }
            };
            Fg(a)
    ...
    var Z = Ta("script"),
        Lg = function() {
            var a = D(z, Pd.g) || D(z, Qd.g) || D(z, Sd.D);
            ...
            a && !z.google_sa_queue && (z.google_sa_queue = [], z.google_sl_win = z, z.google_process_slots = function() {
                return Ig(z)
            }, a = Jg(), hf(z.document, a, "preload", "script"), !v(w, "Chrome") && !v(w, "CriOS") || v(w, "Edge") ? Bb(z.document, a).id = "google_shimpl" : (a = document.createElement("IFRAME"), a.id = "google_shimpl", a.style.display = "none", z.document.documentElement.appendChild(a), uf(z, "google_shimpl", "<!doctype html><html><body>" + ("<" + Z + ">") + "google_sl_win=window.parent;google_async_iframe_id='google_shimpl';" + ("</" + Z + ">") + Kg() + "</body></html>"), a.contentWindow.document.close()))
        },
        ...
        Sg = function(a, b, c) {
            Rg(a, b, c, function(a, b, f) {
                ...
                var k = f.ds || "";
                k && (k += k.endsWith(";") ? "" : ";");
                16 == f.google_reactive_ad_format ? (f = a.createElement("div"), a = tf(b, d, e, k), f.innerHTML = a, c.appendChild(f.firstChild)) : (f = tf(b, d, e, k), c.innerHTML = f);
                return b.id
            })
        },
        Tg = function(a, b) {
            b = "{iframeWin: window, pubWin: window.parent, vars: " + ("window.parent['google_sv_map']['" + b + "']") + "}";
            if (D(a, Pd.g) || D(a, Qd.g) || D(a, Sd.D)) return "<" + Z + ">window.parent.google_sa_impl(" + b + ");</" + Z + ">";
        ...
        Rg = function(a, b, c, d) {
            ...
            if (!p(b.google_reactive_sra_index) || !b.google_ad_unit_key) {
        ...
        Ug = function(a, b) {
            var c = navigator;
            a && b && c && (a = a.document, b = sf(b), /[^a-z0-9-]/.test(b) || ((c = Ea("r20160913")) && (c += "/"), Bb(a, vd("pagead2.googlesyndication.com", "/pub-config/" + c + b + ".js"))))
        };
    var Vg = function(a, b, c) {
        for (var d = a.attributes, e = d.length, f = 0; f < e; f++) {
            var g = d[f];
            if (/data-/.test(g.name)) {
                var h = Ea(g.name.replace("data-matched-content", "google_content_recommendation").replace("data", "google").replace(/-/g, "_"));
        ...
        if (c.document && c.document.body && !ag(b) && !b.google_reactive_ad_format && (d = parseInt(a.style.width, 10), e = lg(a, c), 0 < e && d > e))
            if (f = parseInt(a.style.height, 10), d = !!eb[d + "x" + f], D(c, Md.J)) b.google_ad_resize = 0;
            else {
                h = e;
                if (d)
        ...
        if (!b.google_enable_content_recommendations || 1 != d && 2 != d) {
            ...
            a: if (e = za(Sf, d, "auto", c, a, b, !1, !0), f = D(c, Ud.c), h = D(c, Ud.g), g = jf(c, b.google_ad_client), !(f || h || g) || !wb() || b.google_reactive_ad_format || ag(b) || re(a, b) || 1 == b.google_ad_resize || ic(c) != c) d = !1;
                    ...
                    h = D(c, Wd.c);
                    g = D(c, Wd.g);
                    k = bf(c.location, "google_responsive_slot_debug") || bf(c.location, "google_responsive_slot_preview") || qf(c, Ud.c, Ud.g, Wd.c, Wd.g);
                    var m = L(gf(), 142);
            ...
            if (e = ag(b)) cg(e, a, b, c, d);
                ...
                } else qe(a.style, b), b.google_ad_output && "html" != b.google_ad_output || 300 != b.google_ad_width || 250 != b.google_ad_height || (d = a.style.width, a.style.width = "100%", e = a.offsetWidth, a.style.width = d, b.google_available_width = e);
                c.location && "#gfwmrp" == c.location.hash || 12 == b.google_responsive_auto_format && "true" == b.google_full_width_responsive && !D(c, Cd.g) ? cg(10, a, b, c, !1) : D(c, Dd.g) && 12 == b.google_responsive_auto_format && (a = we(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b), !0 !== a ? (b.efwr = !1, b.gfwrnwer = a) : b.efwr = !0)
            }
    ...
    var Wg = !1,
        ...
        dh = function(a, b, c) {
            ...
            !h || mc(h.ad_whitelist, g, f) ? h = null : (f = h.space_collapsing || "none", h = (g = mc(h.ad_blacklist, g)) ? {
                W: !0,
                da: g.space_collapsing || f
            } : h.remove_ads_by_default ? {
                W: !0,
                da: f,
                pa: h.dont_remove_atf
            } : null);
            if (e = h && h.W && "on" != b.google_adtest && !e) {
                a: {
                    try {
                ...
                m && (m = se(a, c) < ie(c).clientHeight);e = !(m && h.pa)
            }
            ...
            if ((m = B(a, c)) && "none" == m.display && !("on" == b.google_adtest || 0 < b.google_reactive_ad_format || d)) return c.document.createComment && a.appendChild(c.document.createComment("No ad requested because of display:none on the adsbygoogle tag")), !0;
                    ...
                    if (c = $a(b, yc, 3), !c || y(c, 1) <= +new Date) try {
                        ...
                        try {
                            ...
                            if (q) {
                                ...
                                if (y(h, 4)) {
                                    q = {};
                                    var V = new rd(null, (q.google_package = y(h, 4), q));
                                    c = sd(c, V)
                                }
                                var ta = new Se;
                                (new We(new Oe(a, b, c), ta)).start();
                                ta.b.then(za(Ye, l), za(Ze, l))
                            }
                        } catch (gb) {
                            ud(l, {
                                atf: -1
        ...
        kh = function(a, b) {
            ...
            if (c) 0 === Xg && (Xg = 1), fh(b, a), gh(a.google_ad_client), jh(a);
                ...
                } else if (c = eh(), !c) throw new G("All ins elements in the DOM with class=adsbygoogle already have ads in them.");
        ...
        mh = function() {
            ...
            if (!b.plle) {
                ...
                var g = jf(a);
                f ? (f = Ud, g = Vd, e = f.g) : g ? (f = Wd, g = Xd, e = rf(a, new Pc(0, 999), L(e, 120), L(e, 121), [f.c, f.g], 2)) : (f = Ud, g = Vd, e = rf(a, pf, L(e, 96), L(e, 97), [f.c, f.g]));
                if (e) {
                    var h = {};
                ...
                M(c, e);
                g = Ed;
                M(c, rf(a, mf, L(d, 9), L(d, 10), [g.c, g.R]));
                g = Gd;
                ...
                Ea("") && M(b, "");
                g = Md;
                e = N(a, L(d, 11), [g.c, g.J]);
                M(c, e);
                h = "";
                e === g.c ? h = "62710018" : e === g.J && (h = "62710017");
                M(c, h);
                g = Qd;
                ...
                M(c, e);
                if (ff(d, 77) || Tb) g = Sd, e = N(a, L(d, 76), [g.c, g.V, g.K, g.U, g.D]), M(c, e), e || (e = N(a, L(d, 83), [g.T]), M(c, e));
                g = Td;
                ...
                M(b, N(a, L(d, 114), e));
                g = ae;
                e = N(a, L(d, 127), [g.c, g.ja, g.ka]);
                M(c, e);
                g = be;
                e = N(a, L(d, 141), [g.g, g.c]);
                M(c, e)
            }
            hd(D(z, Jd.m) || D(z, Hd.m) || D(z, Hd.P));
            if (D(z, Sd.V) || D(z, Sd.K) || D(z, Sd.U) || D(z, Sd.T)) Eg(), Bg("") && (X[1] = ""), D(z, Sd.K) ? (a = jb(), Hg(a), Gg(a)) : Gg(null);
            D(z, Td.g) && (a = ee() ? Qb("", "pagead2.googlesyndication.com") : Xb(), hf(gc().document, a, "preconnect"));
            if (a = jc(l)) a = he(a), va(a.tagSpecificState) && a.tagSpecificState[1] || !va(a.tagSpecificState) || (a.tagSpecificState[1] = new $e);
